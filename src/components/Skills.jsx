...
function Skills() {
  const skills = [
    ...
    { name: "Azure Data Lake", image: "/images/skills/adl.png" },
    { name: "Azure Key Vault", image: "/images/skills/akv.jpeg" },
    { name: "Azure Databricks", image: "/images/skills/data bricks.png" },
    { name: "Azure Synapse", image: "/images/skills/asy.png" },
    { name: "Azure Webapps", image: "/images/skills/webapp.jpg" },
    { name: "Azure DevOps", image: "/images/skills/dev.jpeg" },
