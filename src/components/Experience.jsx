    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="space-y-4">
          <h3 className="text-2xl text-center font-semibold">Data Engineer – Chubb Ltd (2023 – Present)</h3>
          <h3 className="text-2xl text-center font-semibold">Data Engineer – Wipro Ltd (2020 – 2022)</h3>
        </div>
